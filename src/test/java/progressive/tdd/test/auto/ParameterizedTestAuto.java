...
public class ParameterizedTestAuto extends BaseClass {
	...
	public void createAutoQuoteTest(String validatepagehomeText,String zipCode,String firstName,String lastName,String dateofBirth)throws Exception {
		//homePage.homePageTitle("An Insurance Company You Can Rely On | Progressive");
        //Thread.sleep(3000); 
        homePage.validatehomePageText("validatehomepageText");
        Thread.sleep(5000);		
        ...
        Thread.sleep(7000);
        //WebElement StreetNumberandName=driver.findElement(By.id("//input[@id='CFV']"));
	...
	public void createAutoQuoteTest_AutoData(String validatehomepageText,String zipCode,String firstName,String lastName,String dateofBirth)throws Exception {
